...
export class LitTypewriter extends LitElement {
  static styles = css`
    ...
    .withCursor::after {
      ...
      animation-timing-function: var(--typewriter-cursor-animation-easing, cubic-bezier(0.4, 0.0, 0.2, 1));
  ...
  private _getDirection = () =>
    this.rtlStringIndices.indexOf(this.currentStringIndex) > -1
      ? "rtl"
      : "ltr";
